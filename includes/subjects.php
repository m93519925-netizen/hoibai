...
function get_subjects(): array {
    return [
        ...
        '10-12' => [
            'Bắt buộc – Công cụ & Ngôn ngữ' => ['Toán', 'Ngữ văn', 'Ngoại ngữ 1'],
            'Bắt buộc – Thể chất & An ninh' => ['Giáo dục thể chất', 'Giáo dục quốc phòng và an ninh'],
            ...
            'Chọn – Công nghệ & Nghệ thuật' => ['Công nghệ', 'Tin học', 'Âm nhạc', 'Mỹ thuật'],
        ],
    ];
}
...
function subjects_for_grade(string $grade_group): array {
    return get_subjects()[$grade_group] ?? [];
}
